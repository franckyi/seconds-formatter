const ONE_YEAR = 31536000;
    ...
    alert('Convert seconds to human readable format');
    let seconds = prompt('Enter seconds', 60);

    if(seconds == 0) {
        document.getElementById('js-result').innerHTML = 'You entered 0 seconds';
    }
    else {
        ...
        document.getElementById('js-result').innerHTML = formattedResult;
    }
